...
import (
	...
	"github.com/initialed85/cameranator/pkg/services/segment_processor"
...
func main() {
	...
	segmentProcessor, err := segment_processor.NewSegmentProcessor(port, url, timeout)
	if err != nil {
		log.Fatal(err)
	}

	err = segmentProcessor.Start()
	if err != nil {
		log.Fatal(err)
	}
